...
public class Translator {
    ...
    private boolean parseLine() {
        ...
        Mnemon localAddr = Mnemon.M_IMMEDIATE;
                ...
                case PS_INT:
                    if (aToken instanceof TAddress) {
                        ...
                        if (Maps.addrMnemonTable.containsKey(tempStr.toLowerCase())) {
                            localAddr = Maps.addrMnemonTable.get(tempStr.toLowerCase());
                            terminate = localMnemon == Mnemon.M_END;
                ...
                case PS_ADDR:
                    if (aToken instanceof TEmpty) {
                        if (localMnemon == Mnemon.M_BR) {
                            if (localAddr == Mnemon.M_IMMEDIATE) {
                                localAddr = Maps.brHelperMnemonTable.get("empty");
                            } else {
