...
/**
 * Example 90 from page 65 of <i>Java Precisely</i>, Second edition (The MIT
 * Press 2005).
 *
 * <p>To exercise all paths through the try-catch-finally statement in method m,
 * run this program with each of these arguments:
 *
 * <p>101 102 103 201 202 203 301 302 303 411 412 413 421 422 423 431 432 433
 *
 * <p>like this:
 *
 * <p>java Example90 101
 * <p>java Example90 102
 * <p>etc.
 *
 * <p>File:
 * <code>Example90.java</code>
 *
 * @author Peter Sestoft (sestoft at itu.dk)
 */
